...
void calculateExposureMultiGPU(double* exposures, InterestRateSwap_D payOff, double* accrual, double* spot_rates, double* drift, double* volatilities, int num_gpus, int simN, double dt);
